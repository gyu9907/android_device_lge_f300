...
# Sensors
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/configs/sensor_def_common.conf:system/etc/sensor_def_common.conf \
    $(LOCAL_PATH)/configs/sensor_def_f300.conf:system/etc/sensor_def_variable.conf
