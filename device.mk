...
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/configs/audio_effects.xml:system/vendor/etc/audio_effects.xml \
    $(COMMON_PATH)/configs/audio_policy_configuration.xml:system/vendor/etc/audio_policy_configuration.xml \
    $(COMMON_PATH)/configs/mixer_paths.xml:system/vendor/etc/mixer_paths.xml
...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/gps/etc/quipc.conf:system/etc/quipc.conf \
...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/configs/media_profiles_V1_0.xml:system/vendor/etc/media_profiles_V1_0.xml \
...
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/nfc/libnfc-nci.conf:system/vendor/etc/libnfc-nci.conf \
    $(COMMON_PATH)/nfc/nfcee_access.xml:system/etc/nfcee_access.xml
...
# Sensors
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/configs/sensor_def_common.conf:system/vendor/etc/sensor_def_common.conf \
...
# Thermal
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/configs/thermal-engine-8974.conf:system/vendor/etc/thermal-engine-8974.conf
