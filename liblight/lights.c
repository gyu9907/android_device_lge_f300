...
char const*const RED_LED_FILE
        = "/sys/class/leds/R/brightness";

char const*const GREEN_LED_FILE
        = "/sys/class/leds/G/brightness";
...
char const*const BTN_LEFT_FILE
        = "/sys/class/leds/button-backlight1/brightness";

char const*const BTN_RIGHT_FILE
        ...
        struct light_state_t const* state)
{
    ...
    err = write_int(BTN_LEFT_FILE, on?80:0);
    err = write_int(BTN_RIGHT_FILE, on?80:0);
        ...
        struct light_state_t const* state)
{
    ...
    if (state != NULL) {
        ...
        //ALOGD("set_light_locked: mode %d, color=%08X, onMS=%d, offMS=%d\n",
        //    state->flashMode, state->color, onMS, offMS);
        if (onMS > 0 && offMS > 0) {
            write_str(PTN_BLINK_FILE, 0);
        ...
        struct light_state_t const* state)
{
    ...
    brightness = rgb_to_brightness(&g_attention);
